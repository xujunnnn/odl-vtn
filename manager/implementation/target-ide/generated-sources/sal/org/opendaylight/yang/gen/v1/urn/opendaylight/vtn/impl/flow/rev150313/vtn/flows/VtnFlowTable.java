...
/**
 * Information about data flows present in the VTN. Note that the element for the 
 * VTN that has no data flow may not be present in this list.
 *
 ...
 * <i>vtn-flow-impl/vtn-flows/vtn-flow-table</i>
 *
 * <p>To create instances of this class use {@link org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.flows.VtnFlowTableBuilder}.
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.flows.VtnFlowTableBuilder
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.flows.VtnFlowTableKey
 *
 */
public interface VtnFlowTable
    extends
    ChildOf<VtnFlows>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.flows.VtnFlowTable>,
    TenantFlowInfo,
    Identifiable<VtnFlowTableKey>
{



    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:vtn:impl:flow",
        "2015-03-13", "vtn-flow-table").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.flows.VtnFlowTableKey</code> <code>key</code>, or <code>null</code> if not present
     */
    VtnFlowTableKey getKey();
