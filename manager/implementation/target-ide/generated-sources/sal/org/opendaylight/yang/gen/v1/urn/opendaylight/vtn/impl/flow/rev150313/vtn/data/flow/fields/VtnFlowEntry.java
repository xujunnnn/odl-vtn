...
import org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.VtnFlowEntryInfo;
 ...
 * this list needs to be sorted by `order' field in ascending order. The flow 
 * that has the smallest order indicates the ingress flow entry, and the flow 
 ...
 * <i>vtn-flow-impl/vtn-data-flow-fields/vtn-flow-entry</i>
 *
 * <p>To create instances of this class use {@link org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.data.flow.fields.VtnFlowEntryBuilder}.
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.data.flow.fields.VtnFlowEntryBuilder
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.data.flow.fields.VtnFlowEntryKey
 *
 */
public interface VtnFlowEntry
    extends
    ChildOf<VtnDataFlowFields>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.data.flow.fields.VtnFlowEntry>,
    VtnFlowEntryInfo,
    Identifiable<VtnFlowEntryKey>
{



    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:vtn:impl:flow",
        "2015-03-13", "vtn-flow-entry").intern();
     ...
     *
     *
     * @return <code>org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.vtn.data.flow.fields.VtnFlowEntryKey</code> <code>key</code>, or <code>null</code> if not present
     */
    VtnFlowEntryKey getKey();
