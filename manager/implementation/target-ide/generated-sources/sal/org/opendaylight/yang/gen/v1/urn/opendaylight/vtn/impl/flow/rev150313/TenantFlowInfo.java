 ...
 * <i>vtn-flow-impl/tenant-flow-info</i>
 *
 */
public interface TenantFlowInfo
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:vtn:impl:flow",
        "2015-03-13", "tenant-flow-info").intern();
     ...
     *
     *
     * @return <code>java.util.List</code> <code>vtnDataFlow</code>, or <code>null</code> if not present
     */
    List<VtnDataFlow> getVtnDataFlow();
     ...
     *
     *
     * @return <code>java.util.List</code> <code>matchFlows</code>, or <code>null</code> if not present
     */
    List<MatchFlows> getMatchFlows();
     ...
     *
     *
     * @return <code>java.util.List</code> <code>nodeFlows</code>, or <code>null</code> if not present
     */
    List<NodeFlows> getNodeFlows();
     ...
     *
     *
     * @return <code>java.util.List</code> <code>portFlows</code>, or <code>null</code> if not present
     */
    List<PortFlows> getPortFlows();
     ...
     *
     *
     * @return <code>java.util.List</code> <code>sourceHostFlows</code>, or <code>null</code> if not present
     */
    List<SourceHostFlows> getSourceHostFlows();
