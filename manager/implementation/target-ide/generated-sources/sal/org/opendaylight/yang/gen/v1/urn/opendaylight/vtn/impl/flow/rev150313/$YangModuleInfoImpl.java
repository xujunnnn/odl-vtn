...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final java.lang.String name = "vtn-flow-impl";
    private final java.lang.String namespace = "urn:opendaylight:vtn:impl:flow";
    private final java.lang.String revision = "2015-03-13";
    private final java.lang.String resourcePath = "/META-INF/yang/vtn-flow-impl.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.flow.rev150410.$YangModuleInfoImpl.getInstance());
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.flow.action.rev150410.$YangModuleInfoImpl.getInstance());
