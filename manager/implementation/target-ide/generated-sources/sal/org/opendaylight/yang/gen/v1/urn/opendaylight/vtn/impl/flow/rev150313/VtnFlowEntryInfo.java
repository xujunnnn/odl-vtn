...
/**
 * Describes information about a flow entry. `transaction-id' field describes an 
 * OpenFlow transaction ID associated with a FLOW_MOD message that installed this 
 * flow entry. Null means that this flow entry is not yet installed.
 *
 ...
 * <i>vtn-flow-impl/vtn-flow-entry-info</i>
 *
 */
public interface VtnFlowEntryInfo
    extends
    DataObject,
    Flow,
    Ordered
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:vtn:impl:flow",
        "2015-03-13", "vtn-flow-entry-info").intern();
