 ...
 * <i>vtn-flow-impl/vtn-flows</i>
 *
 * <p>To create instances of this class use {@link org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.VtnFlowsBuilder}.
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.VtnFlowsBuilder
 *
 */
public interface VtnFlows
    extends
    ChildOf<VtnFlowImplData>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.impl.flow.rev150313.VtnFlows>
{



    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:vtn:impl:flow",
        "2015-03-13", "vtn-flows").intern();
     ...
     *
     *
     * @return <code>java.util.List</code> <code>vtnFlowTable</code>, or <code>null</code> if not present
     */
    List<VtnFlowTable> getVtnFlowTable();
