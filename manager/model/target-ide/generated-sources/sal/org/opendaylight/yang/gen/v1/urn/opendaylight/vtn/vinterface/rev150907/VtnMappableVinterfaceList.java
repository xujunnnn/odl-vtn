 ...
 * <i>vtn-vinterface/vtn-mappable-vinterface-list</i>
 *
 */
public interface VtnMappableVinterfaceList
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:vtn:vinterface",
        "2015-09-07", "vtn-mappable-vinterface-list").intern();
     ...
     *
     *
     * @return <code>java.util.List</code> <code>vinterface</code>, or <code>null</code> if not present
     */
    List<Vinterface> getVinterface();
