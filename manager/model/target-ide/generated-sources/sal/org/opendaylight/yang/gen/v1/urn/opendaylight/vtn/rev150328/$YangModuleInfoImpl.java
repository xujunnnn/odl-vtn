...
public final class $YangModuleInfoImpl implements YangModuleInfo {
    ...
    private final java.lang.String name = "vtn";
    private final java.lang.String namespace = "urn:opendaylight:vtn";
    private final java.lang.String revision = "2015-03-28";
    private final java.lang.String resourcePath = "/META-INF/yang/vtn.yang";
    ...
    private $YangModuleInfoImpl() {
        ...
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.pathmap.rev150328.$YangModuleInfoImpl.getInstance());
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.vterminal.rev150907.$YangModuleInfoImpl.getInstance());
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.types.rev150209.$YangModuleInfoImpl.getInstance());
        set.add(org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.vbridge.rev150907.$YangModuleInfoImpl.getInstance());
