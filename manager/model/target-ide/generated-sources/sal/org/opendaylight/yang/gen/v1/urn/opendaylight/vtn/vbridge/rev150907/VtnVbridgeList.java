 ...
 * <i>vtn-vbridge/vtn-vbridge-list</i>
 *
 */
public interface VtnVbridgeList
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:vtn:vbridge",
        "2015-09-07", "vtn-vbridge-list").intern();
     ...
     *
     *
     * @return <code>java.util.List</code> <code>vbridge</code>, or <code>null</code> if not present
     */
    List<Vbridge> getVbridge();
