 ...
 * <i>vtn-flow-filter/vtn-flow-filter-list</i>
 *
 */
public interface VtnFlowFilterList
    extends
    DataObject
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:vtn:flow:filter",
        "2015-09-07", "vtn-flow-filter-list").intern();

    /**
     * Describes a list of flow filters configured in a virtual node in VTN. Each flow 
     * filter in this list needs to have a unique index in `index' field. `index' value
     ...
     *
     *
     * @return <code>java.util.List</code> <code>vtnFlowFilter</code>, or <code>null</code> if not present
     */
    List<VtnFlowFilter> getVtnFlowFilter();
