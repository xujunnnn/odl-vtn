 ...
 * vBridge. Note that this container may not be present if no output flow filter 
 ...
 * <i>vtn-vbridge/vtn-vbridge-info/vbridge-output-filter</i>
 *
 * <p>To create instances of this class use {@link org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.vbridge.rev150907.vtn.vbridge.info.VbridgeOutputFilterBuilder}.
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.vbridge.rev150907.vtn.vbridge.info.VbridgeOutputFilterBuilder
 *
 */
public interface VbridgeOutputFilter
    extends
    ChildOf<VtnVbridgeInfo>,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.vbridge.rev150907.vtn.vbridge.info.VbridgeOutputFilter>,
    VtnFlowFilterList
{
    ...
    public static final QName QNAME = org.opendaylight.yangtools.yang.common.QName.create("urn:opendaylight:vtn:vbridge",
        "2015-09-07", "vbridge-output-filter").intern();
