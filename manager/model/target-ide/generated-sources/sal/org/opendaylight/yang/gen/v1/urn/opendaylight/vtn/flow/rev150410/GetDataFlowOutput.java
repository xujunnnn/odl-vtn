 ...
 * <i>vtn-flow/get-data-flow/output</i>
 *
 * <p>To create instances of this class use {@link org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.flow.rev150410.GetDataFlowOutputBuilder}.
 * @see org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.flow.rev150410.GetDataFlowOutputBuilder
 *
 */
public interface GetDataFlowOutput
    extends
    DataObject,
    Augmentable<org.opendaylight.yang.gen.v1.urn.opendaylight.vtn.flow.rev150410.GetDataFlowOutput>
{
     ...
     *
     *
     * @return <code>java.util.List</code> <code>dataFlowInfo</code>, or <code>null</code> if not present
     */
    List<DataFlowInfo> getDataFlowInfo();
